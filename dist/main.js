...
/* harmony import */ var _icons_folder_move_outline_svg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./icons/folder-move-outline.svg */ "./src/icons/folder-move-outline.svg");
...
const DisplayHandler = (() => {
  ...
  const _autofillTodoInfo = (todoID) => {
    let todoObj = _informationitemmanager_mjs__WEBPACK_IMPORTED_MODULE_0__.InformationItemManager.getTodo(todoID);
    ...
    todoDueDate.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(todoObj.dueDate, 'yyyy-MM-dd') + 'T' + (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(todoObj.dueDate, 'HH:mm');
  ...
  const _displayForm = ({formStr, projID = '', todoID = ''} = {}) => {
    ...
    if (formStr === 'create project form') {
      ...
      let todoItem = _informationitemmanager_mjs__WEBPACK_IMPORTED_MODULE_0__.InformationItemManager.getTodo(todoID);
      ...
      let parentProjectItem = _informationitemmanager_mjs__WEBPACK_IMPORTED_MODULE_0__.InformationItemManager.getProject(projID);
      ...
      moveTodoDueDate.textContent = `Due: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(todoItem.dueDate, 'L/d/yy')}`;
  ...
  const displayTodos = (todoCategoryTypeStr, todoSortStr) => {
    ...
    for (let todoItem of todosArray) {
      ...
      tdDueDateElem.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(todoItem.dueDate, 'L/d/yy');
      ...
      tdCreationDateElem.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(todoItem.creationDate, 'L/d/yy');;
      ...
      tdMoveButtonElem.innerHTML = `
        <img class="todo-item-move-button-icon" src="${_icons_folder_move_outline_svg__WEBPACK_IMPORTED_MODULE_4__}" alt="Move todo button">
      `;
      ...
      tdDeleteButtonElem.innerHTML = `
        <img class="todo-item-delete-button-icon" src="${_icons_trash_can_outline_svg__WEBPACK_IMPORTED_MODULE_3__}" alt="Delete todo button">
      `;
      tdDeleteButtonElem.addEventListener('click', (e) => {
        let todoID = e.currentTarget.parentNode.dataset.todoid;
        _informationitemmanager_mjs__WEBPACK_IMPORTED_MODULE_0__.InformationItemManager.deleteTodo(todoID); // Delete from projectMap
        e.stopPropagation();
  ...
  const attachStaticEventHandlers = () => {
    ...
    createEditFormSubmitButton.addEventListener('click', (e) => {
      ...
      if (createEditFormSubmitButton.dataset.submittype === 'create-project') {
        ...
        let existingTodoItemObj = _informationitemmanager_mjs__WEBPACK_IMPORTED_MODULE_0__.InformationItemManager.getTodo(todoID);
    ...
    moveTodoSubmitButton.addEventListener('click', (e) => {
      ...
      _informationitemmanager_mjs__WEBPACK_IMPORTED_MODULE_0__.InformationItemManager.moveTodo(todoID, targetProjectSelectElem.value);
      let moveTodoForm = document.querySelector('form.move-todo-form');
      moveTodoForm.reset(); // resets form to default values
